...
module.exports = {
  ...
  execute(message, args, client) {
    ...
    message.reply(new MessageEmbed().setColor("BLUE").setTitle("invite fix music").setDescription(" [invite](https://discord.com/api/oauth2/authorize?client_id=802995353209012234&permissions=2192964928&scope=bot)")
