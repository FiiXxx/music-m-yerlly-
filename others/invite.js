...
module.exports = {
  ...
  execute(message, args, client) {
    ...
    message.reply(new MessageEmbed().setColor("#c219d8").setTitle(":heart: Please Invite me: ").setDescription("https://discord.com/api/oauth2/authorize?client_id=824291487763922945&permissions=2214068032&scope=bot")
